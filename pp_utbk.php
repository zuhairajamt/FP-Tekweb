            ...
            <div class="row">
               <div class="col-md-12">
                 <div class="prod-page-title">
                     <h2>Bank Soal Saintek Utbk Sbmptn 2022</h2>
               ...
               <div class="col-md-7 col-sm-8">
                  <div class="md-prod-page">
                        ...
                        <div class="page-preview">
                           <div class="preview">
                              <div class="preview-pic tab-content">
                                 <div class="tab-pane active" id="pic-1"><img src="images/utbk.jpg" alt="#" /></div>
                                 <div class="tab-pane" id="pic-2"><img src="images/utbk.jpg" alt="#" /></div>
                              </div>
                              <ul class="preview-thumbnail nav nav-tabs">
                                 <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="images/utbk.jpg" alt="#" /></a></li>
                              </ul>
                           </div>
                        </div>
                     ...
                     <div class="description-box">
                        <div class="dex-a">
                           <h4>Synopsis</h4>
                           <p>BANK SOAL SAINTEK UTBK SBMPTN 2022
                           </p>
                           <br>
                        </div>
                        <div class="spe-a">
