            ...
            <div class="row">
               <div class="col-md-12">
                 <div class="prod-page-title">
                     <h2>Distribusi Daya Listrik, Teori Dan Praktik</h2>
                     <p>Cekmas Cekdin</p>
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-7 col-sm-8">
                  <div class="md-prod-page">
                        ...
                        <div class="page-preview">
                           <div class="preview">
                              <div class="preview-pic tab-content">
                                 <div class="tab-pane active" id="pic-1"><img src="images/daya.jpg" alt="#" /></div>
                                 <div class="tab-pane" id="pic-2"><img src="images/daya.jpg" alt="#" /></div>
                              </div>
                              <ul class="preview-thumbnail nav nav-tabs">
                                 <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="images/daya.jpg" alt="#" /></a></li>
                              </ul>
                           </div>
                        </div>
                     ...
                     <div class="description-box">
                        <div class="dex-a">
                           <h4>Synopsis</h4>
                           <p>Buku berjudul Distribusi Daya Listrik -Teori dan Praktik yang berisi tentang teori dan contoh soal dengan penyelesaiannya, yang dikhususkan bagi mahasiswa Jui.usan Teknik Elektro. Namun, tidak menutup kemungkinan bagi disiplin ilmu yang lain untuk mengembangkan sesuai dengan bidangnya.
                           </p>
                           <br>
                        </div>
                        <div class="spe-a">
