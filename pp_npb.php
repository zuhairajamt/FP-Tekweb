               ...
               <div class="col-md-7 col-sm-8">
                  <div class="md-prod-page">
                        ...
                        <div class="page-preview">
                           <div class="preview">
                              <div class="preview-pic tab-content">
                                 <div class="tab-pane active" id="pic-1"><img src="images/npb_book.png" alt="#" /></div>
                                 <div class="tab-pane" id="pic-2"><img src="images/npb_2.png" alt="#" /></div>
                              </div>
                              <ul class="preview-thumbnail nav nav-tabs">
                                 <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="images/npb_book.png" alt="#" /></a></li>
                                 <li><a data-target="#pic-2" data-toggle="tab"><img src="images/npb_2.png" alt="#" /></a></li>
                              </ul>
                           </div>
                        </div>
                     ...
                     <div class="description-box">
                        <div class="dex-a">
                           <h4>Synopsis</h4>
                           <p>Thomas, seorang konsultan keuangan profesional sekaligus founder perusahaan konsultasi keuangan terkemuka berlabel Thomas & Co. yang serba misterius. Kemampuaanya dalam bidang ekonomi tidak diragukan lagi, ia sering diundang sebagai pembicara pertemuan-pertemuan besar di dunia. Namun ketika ditelusuri latar belakangnya, semua gelap.
                           </p>
                           <br>
                        </div>
                        <div class="spe-a">
                        ...
                        <div class="col-md-6">
                           <div class="small-box-c">
                              <div class="small-img-b">
                                 <img class="img-responsive" src="images/Ubur-ubur-Lembur.png" alt="#" />
                              </div>
                              <div class="dit-t clearfix">
                                 <div class="left-ti">
                                   <a href="pp_uul.php"><h4>Ubur-ubur Lembur</h4></a>
                                    <p>Raditya Dika</p>
                                 </div>
