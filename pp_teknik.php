            ...
            <div class="row">
               <div class="col-md-12">
                 <div class="prod-page-title">
                     <h2>Teori Dan Aplikasi Teknik Listrik</h2>
                     <p>Drs. Daryanto</p>
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-7 col-sm-8">
                  <div class="md-prod-page">
                        ...
                        <div class="page-preview">
                           <div class="preview">
                              <div class="preview-pic tab-content">
                                 <div class="tab-pane active" id="pic-1"><img src="images/teknik.jpg" alt="#" /></div>
                                 <div class="tab-pane" id="pic-2"><img src="images/teknik.jpg" alt="#" /></div>
                              </div>
                              <ul class="preview-thumbnail nav nav-tabs">
                                 <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="images/teknik.jpg" alt="#" /></a></li>
                              </ul>
                           </div>
                        </div>
                     ...
                     <div class="description-box">
                        <div class="dex-a">
                           <h4>Synopsis</h4>
                           <p>Teknik listrik adalah salah satu bidang ilmu teknik mengenai aplikasi listrik untuk memenuhi kebutuhan dari kehidupan manusia.
                           </p>
                           <br>
                        </div>
                        <div class="spe-a">
