            ...
            <div class="row">
               <div class="col-md-12">
                 <div class="prod-page-title">
                     <h2>Mekanika Tanah 1 Konsep Dasar Dan Pengukuran Laboratorium</h2>
               ...
               <div class="col-md-7 col-sm-8">
                  <div class="md-prod-page">
                        ...
                        <div class="page-preview">
                           <div class="preview">
                              <div class="preview-pic tab-content">
                                 <div class="tab-pane active" id="pic-1"><img src="images/tanah.jpg" alt="#" /></div>
                                 <div class="tab-pane" id="pic-2"><img src="images/tanah.jpg" alt="#" /></div>
                              </div>
                              <ul class="preview-thumbnail nav nav-tabs">
                                 <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="images/tanah.jpg" alt="#" /></a></li>
                              </ul>
                           </div>
                        </div>
                     ...
                     <div class="description-box">
                        <div class="dex-a">
                           <h4>Synopsis</h4>
                           <p>Sekilas ketika mendengar ilmu yang membahas tentang tanah, seringkali mengarah pada bebrapa bidang ilmu yang tidak jauh-jauh dari pertanian, atau bidang ilmu hukum dan politik pertanahan (agraria). Bahkan, di beberapa perguruan tinggi telah didirikan jurusan/prodi khusus tentang ilmu tanah.
                           </p>
                           <br>
                        </div>
                        <div class="spe-a">
