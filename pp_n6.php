                        ...
                        <div class="page-preview">
                           <div class="preview">
                              <div class="preview-pic tab-content">
                                 <div class="tab-pane active" id="pic-1"><img src="images/naruto6.jpg" alt="#" /></div>
                              </div>
                              <ul class="preview-thumbnail nav nav-tabs">
                                 <li class="active"><a data-target="#pic-1" data-toggle="tab"><img src="images/naruto6.jpg" alt="#" /></a></li>
                              </ul>
                           </div>
                        </div>
                  ...
                  <div class="similar-box">
                     ...
                     <div class="row cat-pd">
                        <div class="col-md-6">
                           <div class="small-box-c">
                              ...
                              <div class="dit-t clearfix">
                                 <div class="left-ti">
                                   <a href="pp_n2.php"><h4>Naruto Vol 1</h4></a>
                                    <p>Masashi Kishimoto</p>
                                 </div>
                        ...
                        <div class="col-md-6">
                           <div class="small-box-c">
                              ...
                              <div class="dit-t clearfix">
                                 <div class="left-ti">
                                    <a href="pp_2.php"><h4>Naruto Vol 2</h4></a>
                                    <p>Masashi Kishimoto</p>
                                 </div>
                                 <a href="#" tabindex="0">Rp 20.000,00</a>
                              </div>
                     ...
                     <div class="row cat-pd">
                        <div class="col-md-6">
                           <div class="small-box-c">
                              <div class="small-img-b">
                                 <img class="img-responsive" src="images/naruto3.jpg" alt="#" />
                              </div>
                              <div class="dit-t clearfix">
                                 <div class="left-ti">
                                    <a href="pp_n3.php"><h4>Naruto Vol 3</h4></a>
                                    <p>Masashi Kishimoto</p>
                                 </div>
                                 <a href="#" tabindex="0">Rp 20.000,00</a>
                              </div>
